...
int CTextureManager::GetDXGIFormatBitsPerPixel(DXGI_FORMAT& dxgiFormat)
{
	...
	else { throw std::exception("Invalid Normal Number"); return -1; }
}

DXGI_FORMAT CTextureManager::GetDXGIFormatFromWICFormat(WICPixelFormatGUID& wicFormatGUID)
{
...
WICPixelFormatGUID CTextureManager::GetConvertToWICFormat(WICPixelFormatGUID& wicFormatGUID)
{
