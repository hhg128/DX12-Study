...
{
	SetLens(0.25f*MathHelper::Pi, 800.f/600.f, 0.1f, 1000.0f);
}
...
XMFLOAT3 CameraClass::GetPosition3f()const
{
	return mPosition;
}
...
XMFLOAT3 CameraClass::GetRight3f()const
{
	return mRight;
}

XMVECTOR CameraClass::GetUp()const
{
	return XMLoadFloat3(&mUp);
}

XMFLOAT3 CameraClass::GetUp3f()const
{
	return mUp;
}

XMVECTOR CameraClass::GetLook()const
{
	return XMLoadFloat3(&mLook);
}

XMFLOAT3 CameraClass::GetLook3f()const
{
	return mLook;
}
...
XMFLOAT4X4 CameraClass::GetView4x4f()const
{
	assert(!mViewDirty);
	return mView;
}

XMFLOAT4X4 CameraClass::GetProj4x4f()const
{
	return mProj;
}
